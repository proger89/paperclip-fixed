...
export const PLUGIN_ID = "paperclip.telegram-publishing";
...
export const SLOT_IDS = {
  settingsPage: "telegram-publishing-settings-page",
  dashboardWidget: "telegram-publishing-dashboard-widget",
  sidebar: "telegram-publishing-sidebar-link",
  page: "telegram-publishing-page",
  issueTab: "telegram-publishing-issue-tab",
} as const;

export const EXPORT_NAMES = {
  settingsPage: "TelegramPublishingSettingsPage",
  dashboardWidget: "TelegramPublishingDashboardWidget",
  sidebar: "TelegramPublishingSidebarLink",
  page: "TelegramPublishingPage",
  issueTab: "TelegramPublishingIssueTab",
} as const;
